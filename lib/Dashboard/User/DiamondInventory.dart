                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                },child: Text("──── Range ────", style: TextStyleHelper.mediumWhite,)),
                                                const SizedBox(height: 5),
                                                Padding(
                                      ...
                                      Positioned(
                                          ...
                                          child: TextButton(onPressed: (){
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => ImageWebViewScreen(imageUrl: 'Assets/Images/GIA.webp'),
                                              ),
                                            );
                                            ...
                                            child: Text('Certs',style: TextStyle(color: AppColors.primaryColour),),
                                          )),),)
                                    ],
                                                                    );
                                  } else {
...
// );
// }
// },icon: Icon(Icons.share),color: AppColors.primaryWhite,)),